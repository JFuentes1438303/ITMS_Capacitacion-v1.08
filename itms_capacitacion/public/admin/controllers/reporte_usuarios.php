	...
	<div class="list-group list-group-flush b_right">
		<ul class="navbar-nav list-group-item-action enlaces2 b_bottom2">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<hr>
					<a class="dropdown-item" href="../../models/cerrar_sesion.php" style="padding-top: 0.1%">
					Cerrar sesión
					</a>
				</div>
			</li>
		...
		<ul class="navbar-nav list-group-item-action enlaces2">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a class="dropdown-item" href="reporte_usuarios.php">Reporte usuarios</a>
					<hr>
					<a class="dropdown-item" href="../../admin/models/rol.php" style="padding-top: 0.1%">
						Actualizar rol
					</a>
				</div>
			</li>
		...
		<a href="../../admin/views/archivos_audio.php" class="list-group-item list-group-item-action enlaces">
			<div class="barra"></div>
			<span>Audios</span>
		</a>

		<a href="../../admin/views/archivos_video.php" class="list-group-item list-group-item-action enlaces">
			<div class="barra"></div>
			<span>Videos</span>
		</a>

		<a href="../../admin/views/archivos_multimedia.php" class="list-group-item list-group-item-action enlaces">
			<div class="barra"></div>
			<span>Multimedia</span> 
		</a>

		<a href="../../admin/views/archivos_documento.php" class="list-group-item list-group-item-action enlaces">
			<div class="barra"></div>
...
<?php
			$sql2 = "SELECT * FROM usuarios WHERE rol = 'USUARIO' LIMIT $inicio_registro, $por_pagina";
...
?>	
			...
			<div class="row t_centro espacio2" style="font-size: 14px">
				...
				<div class="col-sm-2"><?php echo $ddocumento ?></div>
				<div class="col-sm-1"><?php echo $rrol ?></div>
