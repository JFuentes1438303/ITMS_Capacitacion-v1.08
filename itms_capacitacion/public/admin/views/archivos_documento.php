    ...
    <div class="d-flex toggled" id="wrapper">
      ...
      <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush b_right">
          ...
          <a href="archivos_audio.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
            <span>Audios</span>
          </a>

          <a href="archivos_video.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
            <span>Videos</span>
          </a>

          <a href="archivos_multimedia.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
            <span>Multimedia</span> 
          </a>

          <a href="archivos_documento.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
