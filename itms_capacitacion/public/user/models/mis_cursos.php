...
<?php 	
	...
	echo "<div class='col-sm-4 t_centro'>";
		echo "<a href='../../user/models/eliminar_archivo.php?eliminar=".$registro2['id_archivo']."' class='btn btn-sm btn-outline-danger' onclick='return eliminar()' title='Eliminar Archivo'><i class='fas fa-trash-alt'></i></a>";
	echo "</div>";
	echo "</div>";
	}
	...
	<?php  
		...
		echo "<div class='row centro'>";
			...
			if ($pagina_actual != 1) {
				...
				echo "<li><a class='btn btn-sm page-link flecha' href='mis_cursos.php?pagina=".($pagina_actual-1)."'>";
			...
			for ($i=1; $i <= $total_paginas; $i++) { 
				if($pagina_actual == $i){
					echo "<li><a class='btn btn-sm page-link pagina active' href='mis_cursos.php?pagina=".$i."'>".$i."</a>";
				}else{
					echo "<li><a class='btn btn-sm page-link pagina' href='mis_cursos.php?pagina=".$i."'>".$i."</a>";
				}
			}
