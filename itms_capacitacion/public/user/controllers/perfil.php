    ...
    <div class="d-flex toggled" id="wrapper">
      ...
      <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush b_right">
          <ul class="navbar-nav list-group-item-action">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="../../user/views/subir_curso.php">Subir curso</a>
                <a class="dropdown-item" href="../../user/views/mis_cursos.php">Mis cursos</a>
                <a class="dropdown-item" href="../../user/models/actualizar_perfil.php">Actualizar perfil</a>
                <hr>
          ...
          <a href="../../user/views/archivos_audio.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
            <span>Audios</span>
          </a>

          <a href="../../user/views/archivos_video.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
            <span>Videos</span>
          </a>

          <a href="../../user/views/archivos_multimedia.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
            <span>Multimedia</span> 
          </a>

          <a href="../../user/views/archivos_documento.php" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
